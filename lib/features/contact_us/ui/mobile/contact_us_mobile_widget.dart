  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const Text(
            "If you are a student, entrepreneur, have any opportunities for collaboration, or simply wish to engage in a conversation, feel free to send me an intriguing email at: 👇"),
        const SizedBox(height: 8),
        Text(
        ...
        const Center(
          child: Column(
            ...
            children: [
              Text('Coded by Pawan with 💚 in India'),
            ],
          ),
        )
      ]),
